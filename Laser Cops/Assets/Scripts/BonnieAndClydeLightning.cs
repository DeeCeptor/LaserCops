...
// this is a copy of the tether lightning script modded to be on Bonnie and Clyde
public class BonnieAndClydeLightning : MonoBehaviour {

    public static BonnieAndClydeLightning enemy_tether_lightning;
    ...
    void Update()
    {
            ...
            cur_lightning_cooldown <= 0 && Tether.tether.middle_link != null)
        {
            ...
            Vector2 pos1 = clyde.transform.position;
            Vector2 pos2 = bonnie.transform.position;

            CreatePooledBolt(pos1, pos2, Tether.tether.primary_colour, 1f, -1);
            CreatePooledBolt(pos2, pos1, Tether.tether.primary_colour, 1f, -1);
        }
        /*
